...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = \
            'postgresql://{}:{}@{}/{}'.format('postgres', 'robot9000',
        ...
        with self.app.app_context():
            ...
            self.db.create_all()
        self.new_movie = {'title': 'Attack On Titan',
                          'release_date': '8-7-2026'}
        self.new_actor = {'name': 'Tota', 'age': 28, 'gender': 'male'}
        self.director_role_token = \
            'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InlPWlpYZGlEeGRUODFjZ3dWRXIyRiJ9..JcZp3mELB6FyMhkVZsWafear3Wj-k2t4OFoFPz0Rmie3yasxAqLd1byfi_BueClQeo_n9kTUlaGrAc3FSrFcpzO8dELE9UnGN0HL31oX7iKFAGWPbDgNft_AV0TaNYEDkjtNyrHOvzGCT2QFEKfvbbjB6k6H3kF13jS2lL4Kpc0bd4AAj4ch8pCAz9TeaCySM6wgOOzrhz9fvuLxup6UeOmcAyFOgPU05MVL_ZHYbbqa-a0t2DpekdLfh6vGmAu97ecBMgLBKdcbkWjJqsDrKLY50jZl8cRbG5E05UPk4CCB4H8jS3C5pLHvcQer_C2fP9EqWzNMBn5OTIVXlzsmLQ'
        self.assistant_role_token = \
            'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InlPWlpYZGlEeGRUODFjZ3dWRXIyRiJ9..TyYuLICh14msMs_62dbnfWBIwoYD7chOHeSZkzLrCEdmPzGJaQirP8YdLOehVbrfMwzYTd83H4o3AAk0IEbVTXs0AD-yXFSNIx3qCYYs7YoRuk6BJPViJTgoEwLUmgKgpbc5xMnzWsl1p4snYmnXi0J2FLI8-gGp5lDn7Ok8eokwX7-80FzpY_4LwtUCZHhL__AV9J1Strkq-0tBGh-1uxk97_TptHrP7ycMEarzjcroah7AlMnweJi2KayFb8bJU5FuTTVo_pZPcuGlAg5XpJ_41zqQWUlPIB7bVPlP3tSmkVN56gkmyr0w3PpYpaDLO-6gdOY2NPijO4Vrh-NbJw'
        self.producer_role_token = \
            'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InlPWlpYZGlEeGRUODFjZ3dWRXIyRiJ9..XnoAVhkfbXdRQG1lcHXLcGWIXD7OEqS0C-Z2da9CIX3MeLp9n2lmR5npvQziTsEFORR4fSeJ66VkEyqb2M3gf8cielabQuegNCqTBd9qBLvnRDcDiFNHjEdrbRkcaTj5g_TSkcn4xdn2op1baCBTPsCDcWSYxxWjeIu1bgO4BibNzfbRx_j9KEpkvV88YMX1N4GJSW_BbqwQ4dw8ExRBXOWeFUC2KTAGKeUSleYZ7xuJVCpL9NyC_GZ3m4NdXz-GfSZ4sOTMALuMk-n3OT4LSNPJFhqihzJNGQYrBP1y2sq8xhe-VfPD-VNO_Xm3rSev1ai7DVKIl51_FWbizs-4Yg'
    ...
    def test_create_movie(self):
        ...
        data = json.loads(res.data)
        movie = Movie.query.filter(Movie.title == 'Attack On Titan'
                                   ).first()
    ...
    def test_create_actor(self):
        res = self.client().post('/actors', data=dict(name='Moneca5',
